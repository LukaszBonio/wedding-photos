...
describe('OfflineView', () => {
  ...
  it('reassures the guest and shows the pending count', () => {
    ...
    store.photos.push(
      { uploadId: 'a', objectUrl: 'blob:a', mimeType: 'image/jpeg', status: 'offline', progress: 0, error: null },
      { uploadId: 'b', objectUrl: 'blob:b', mimeType: 'image/jpeg', status: 'offline', progress: 0, error: null },
    );
